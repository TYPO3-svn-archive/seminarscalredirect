...
class tx_seminarscalredirect_pi1 extends tslib_pibase {
	var $prefixId      = 'tx_seminarscalredirect_pi1';		// Same as class name
	var $scriptRelPath = 'pi1/class.tx_seminarscalredirect_pi1.php';	// Path to this script relative to the extension dir.
	var $extKey        = 'seminarscalredirect';	// The extension key.
